...
// Реальные вопросы с телефона + реальные ответы мастеров. Пока пусто —
// наполняется по мере поступления, страница на сайте держит честное
// пустое состояние вместо выдуманных вопросов.

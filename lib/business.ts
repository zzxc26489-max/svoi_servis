...
export const PRICES: PriceGroup[] = [
  {
    ...
    items: [
      {
        title: "Диагностика и ремонт холодильников",
        price: 500,
        note: "бесплатно, если заказываете ремонт",
      },
  ...
  },
  {
    ...
    items: [
      {
        title: "Диагностика и ремонт стиральных машин",
        price: 500,
        note: "бесплатно, если заказываете ремонт",
      },
  ...
  },
  {
    ...
    items: [
      {
        title: "Диагностика и ремонт посудомоечных машин",
        price: 500,
        note: "бесплатно, если заказываете ремонт",
      },
      { title: "Не сливает воду", price: 500 },

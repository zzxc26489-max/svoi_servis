...
const faqItems = [
  ...
  {
    question: "А если не получится починить?",
    answer: `${BUSINESS.warranty.refund} Если после диагностики окажется, что ремонт невыгоден — скажем прямо, что технику дешевле заменить, и навязывать работу не станем.`,
  },
  {
    question: "Сколько времени займёт ремонт?",
    answer:
      "Зависит от поломки, а её видно только после диагностики: «заправить фреон» нередко оборачивается утечкой в контуре или мёртвым компрессором. Простое устраняем на месте, под редкие запчасти срок называем сразу, как станет понятна причина — заранее выдумывать не будем.",
  },
  {

...
const advantages = [
  ...
  },
  {
    icon: ToolboxIcon,
    title: "Любая техника",
    // Сроки ремонта на сайте не обещаем: пока не вскрыли технику, их
    // честно не назвать — «заправить фреон» оборачивается утечкой,
    // мёртвым компрессором и ожиданием редкой запчасти.
    description: `Берёмся за любую бытовую технику. ${BUSINESS.warranty.refund}`,
  },
];
